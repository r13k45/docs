...
[Middleware](/oss/javascript/langchain/middleware) provides additional hooks that run **between** these steps, allowing you to modify context as it flows through the agent loop. This enables persisting changes to messages, or other context, between the model call and tool execution.

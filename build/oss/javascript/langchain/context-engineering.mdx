...
At each stage of the agent loop, you can read from (and sometimes write to) different data sources. LangChain uses [middleware](/oss/javascript/langchain/middleware) to give you fine-grained control over context at each stage.

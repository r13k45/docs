...
When an interrupt is triggered, the agent pauses execution and returns control. You must check for interrupts in the result and handle them accordingly.
...
### Tailor Configurations by Risk Level

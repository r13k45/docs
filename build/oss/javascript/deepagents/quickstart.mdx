...
This guide walks you through creating your first deep agent with planning, file system tools, and subagent capabilities.

You'll build a research agent that can conduct research and write reports.
...
- **Add long-term memory** - Enable [persistent memory](/oss/javascript/deepagents/customization#long-term-memory) across conversations

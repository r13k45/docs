...
The model node is where the LLM is called. You have full control over what gets passed to the LLM at this stage. Using [middleware](/oss/python/langchain/middleware), you can dynamically adjust:

- [**System prompt**](/oss/python/langchain/middleware#system-prompt): Set instructions based on State, Store, or Runtime Context
- [**Messages**](/oss/python/langchain/middleware#messages): Trim, summarize, or transform the conversation history
- [**Tools**](/oss/python/langchain/middleware#tools): Dynamically select which tools are available
- [**Model**](/oss/python/langchain/middleware#model): Switch between different models based on context
- [**Response format**](/oss/python/langchain/middleware#response-format): Control structured output schemas

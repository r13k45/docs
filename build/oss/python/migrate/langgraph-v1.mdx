...
## Deprecation: `create_react_agent` → `create_agent`
...
| `ValidationNode` | tools automatically validate input with `langchain.agents.create_agent` |

...
<Tabs>
    ...
    - Breaking changes to the public API will only occur in major version releases (e.g., 2.0)
    - Minor version bumps (e.g., 1.0 to 1.1) add new features without breaking changes

...
- **tools** (`List[Callable]`): Tools the subagent can use. Keep this minimal—only include what's needed.

**Optional fields:**
- **model** (`str | BaseChatModel`): Override the main agent's model. Use format `"provider:model-name"` (e.g., `"openai:gpt-4o"`).
...
### Pattern: Multiple Specialized Subagents
